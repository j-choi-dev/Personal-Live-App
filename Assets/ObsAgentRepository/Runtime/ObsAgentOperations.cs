...
namespace ObsAgent
{
    public sealed class ObsAgentOperations
    {
        ...
        public bool IsObsRunning()
        {
            ...
            {
                Process[] processes =
                    Process.GetProcessesByName("obs64");
        ...
        public async Task<AgentApiResponse> LaunchObsAsync(
            CancellationToken cancellationToken )
        {
            ...
            try
            {
                ...
                return AgentApiResponse.Ok(
                    launched
                        ? "OBS를 실행하고 초기 설정을 적용했습니다."
                        : "실행 중인 OBS에 설정을 적용했습니다.",
                    true,
                    launched );
            }
        ...
        public Task<AgentApiResponse> TestConnectionAsync(
            CancellationToken cancellationToken )
        {
